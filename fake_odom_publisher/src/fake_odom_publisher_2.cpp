...
int main(int argc, char** argv)
{
    ...
    while(n.ok())
    {
        ...
        if (msg_received == true)
        {
			...
			delta_x = vx * dt;//last_vx
            delta_y = vy * dt;//last_vy
		...
		//delta_trans.transform.rotation.x = 0.0;
		//delta_trans.transform.rotation.y = 0.0;
		//delta_trans.transform.rotation.z = odom_orientation_z;
		//delta_trans.transform.rotation.w = odom_orientation_w;
        ...
        if (transformRecieved)
        {
          ...
          odom_trans.transform.translation.x = x;//frameTransform.getOrigin().x();
          odom_trans.transform.translation.y = y;//frameTransform.getOrigin().y();
          odom_trans.transform.translation.z = 0.0;
		  odom_trans.transform.rotation.x = 0.0;
		  odom_trans.transform.rotation.y = 0.0;
		  odom_trans.transform.rotation.z = odom_orientation_z;
		  odom_trans.transform.rotation.w = odom_orientation_w;
        ...
        odom.twist.twist.linear.x = vLinear;//vx;
