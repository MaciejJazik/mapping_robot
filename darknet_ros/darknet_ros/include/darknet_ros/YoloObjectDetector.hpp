...
#include <darknet_ros_msgs/ObjectCoordinates.h>
...
class YoloObjectDetector {
 ...
 private:
  ...
  ros::Publisher coordinatesPublisher_;
  ...
  // Depth Image - Fpr depth inclussion
  cv::Mat DepthImageCopy_;
  void Coordinates(int xmin, int ymin, int xmax, int ymax);
  float X;
  float Y;
  float Z;
